...
class aula15
{
    static void Main()
    {
        ...
        Console.WriteLine("Valor {0} está na posição {1}", procurado,pos);  //Retorna a posição do valor procurado
        Console.WriteLine("-------------------------------------------");   //Caso for retornado -1, não foi encontrado

        //public static void Copy(Ar_origem,Ar_destino,qtde_elementos);
        Console.WriteLine("Copy");
        Array.Copy(vetor1,vetor2,vetor1.Length);    //Copia os valores de um vetor e passa para outro
        ...
        vetor1.CopyTo(vetor3,0);    //Copia valores a partir de um determinado indice para o vetor de destino
